...
void Forecast::set_fcst_time_from (const QString& fcst_time_from)
{
    ...
    Function::replace_time (_fcst_time_from);
}
void Forecast::set_fcst_time_to (const QString& fcst_time_to)
{
    this->_fcst_time_to = fcst_time_to;
    Function::replace_time (_fcst_time_to);
}
void Forecast::set_change_indicator (const QString& change_indicator) { this->_change_indicator = change_indicator; }
void Forecast::set_time_becoming (const QString& time_becoming) { this->_time_becoming = time_becoming; }
...
void Forecast::set_wind_speed_kt (const QString& wind_speed_kt) { this->_wind_speed_kt = wind_speed_kt; }
void Forecast::set_wind_gust_kt (const QString& wind_gust_kt) { this->_wind_gust_kt = wind_gust_kt; }
void Forecast::set_wind_shear_hgt_ft_agl (const QString& wind_shear_hgt_ft_agl) { this->_wind_shear_hgt_ft_agl = wind_shear_hgt_ft_agl; }
...
void Forecast::set_wind_shear_speed_kt (const QString& wind_shear_speed_kt) { this->_wind_shear_speed_kt = wind_shear_speed_kt; }
void Forecast::set_visibility_statute_mi (const QString& visibility_statute_mi) { this->_visibility_statute_mi = visibility_statute_mi; }
void Forecast::set_altim_in_hg (const QString& altim_in_hg) { this->_altim_in_hg = altim_in_hg; }
void Forecast::set_vert_vis_ft (const QString& vert_vis_ft) { this->_vert_vis_ft = vert_vis_ft; }
