...
const QString &METAR::getWind_gust_kt() const
{
    return wind_gust_kt;
}
const QString& METAR::getVisibility_statute_mi () const { return visibility_statute_mi_; }
const QString& METAR::getAltim_in_hg () const { return altim_in_hg_; }
...
void METAR::setObservation_time (const QString& newObservation_time) {
    observation_time_ = Function::replace_time (newObservation_time); }
...
void METAR::setWind_speed_kt (const QString& newWind_speed_kt) {
    wind_speed_kt =Function::convert_kt_to_ms(newWind_speed_kt); }
void METAR::setWind_gust_kt(const QString &newWind_gust_kt)
{
    wind_gust_kt = Function::convert_kt_to_ms(newWind_gust_kt);
}
...
void METAR::setVisibility_statute_mi (const QString& newVisibility_statute_mi) { visibility_statute_mi_ =Function::convert_mi_to_m(newVisibility_statute_mi); }
